...
\usepackage[paperwidth=136.4mm, paperheight=168.0mm]{geometry} % Kindle Oasis 3 (2019)
\geometry{left=10mm,right=10mm,top=20mm,bottom=10mm,foot=20mm}
%\setlength{\textwidth}{63.2mm}
%\setlength{\textheight}{84.0mm}
...
\begin{document}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=8cm]{./Images/Title.png}
	\end{figure}
